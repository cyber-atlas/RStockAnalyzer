...
### The Datasets 
<br>
The datasets we used in this investigation were obtained from Yahoo Finance using the quantmod package and from New York Stock Exchange Kaggle dataset. The link to the datasets are below. 
...
## Added the chart with highlights 
